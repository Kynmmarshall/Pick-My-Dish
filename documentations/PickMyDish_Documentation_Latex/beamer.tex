...
\setbeamertemplate{background}{
    \begin{tikzpicture}[remember picture, overlay]
        ...
        \fill[top color=white, bottom color=Primary!25] 
...
% ============================================================
% SLIDE 3: SCRUM & KANBAN PROCESS
% ============================================================
\begin{frame}{Scrum \& Kanban Process}
    \vspace*{0.2cm}
    
    \centering
    \textcolor{Primary}{\large \textbf{Agile Project Management Methodology}}
    
    \vspace{0.3cm}
    
    \begin{columns}[T]
        % Left Column: Daily Scrum Meeting
        \begin{column}{0.48\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \node[rectangle,
                      ...
                      minimum width=5cm,
                      text=Primary,
                      font=\bfseries] (scrum-title) at (0,0) 
                      {\faCalendarCheck~Daily Scrum Meeting};
                ...
                \node[rectangle,
                      ...
                      below=0.2cm of scrum-title] (scrum-image) 
                      {\includegraphics[width=6cm]{discord-standup.png.png}};
                ...
                \node[rectangle,
                    ...
                    align=left,
                    font=\small,
                    below=0.2cm of scrum-image] (scrum-desc) {
                    \textbf{Daily Scrum:} 15-min team sync\\
                    \textbf{3 Questions:} Yesterday/Today/Blockers\\
                    \textbf{Outcome:} Kanban board updates\\
                };
            \end{tikzpicture}
        \end{column}
        ...
        \begin{column}{0.48\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \node[rectangle,
                      ...
                      minimum width=5cm,
                      text=Secondary,
                      font=\bfseries] (kanban-title) at (0,0) 
                ...
                \node[rectangle,
                      ...
                      minimum width=5cm,
                      minimum height=3.5cm,
                      below=0.2cm of kanban-title] (kanban-image) 
                      {\includegraphics[width=6cm]{github-kanban.png}};
                ...
                \node[rectangle,
                    ...
                    align=left,
                    font=\small,
                    below=0.3cm of kanban-image] (kanban-desc) {
                    \textbf{Kanban Flow:} \textit{To Do → In Progress → Review → Done}\\
                    \textbf{WIP Limits:} Max 3 tasks/column\\
    ...
    \begin{center}
        \begin{tikzpicture}
            \fill[Primary!20, rounded corners=4pt] 
                (0,0) rectangle (12cm, 0.8cm);
            \node[text=DarkBg, font=\small] at (6cm, 0.4cm) 
                {\faTrello~Agile methodology for efficient project management~\faTasks};
        \end{tikzpicture}
    \end{center}
\end{frame}
